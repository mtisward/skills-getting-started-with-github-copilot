...
activities = {
    ...
    "Tennis Club": {
        "description": "Tennis training and competitions for all skill levels",
        "schedule": "Tuesdays and Saturdays, 3:00 PM - 4:30 PM",
        "max_participants": 16,
        "participants": ["david@mergington.edu"]
    },
    "Art Studio": {
        "description": "Painting, drawing, and visual arts creative expression",
        "schedule": "Wednesdays and Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
        "participants": ["isabella@mergington.edu", "mia@mergington.edu"]
    },
    "Drama Club": {
        "description": "Theater production, acting, and performing arts",
        "schedule": "Thursdays and Sundays, 4:00 PM - 6:00 PM",
        "max_participants": 25,
